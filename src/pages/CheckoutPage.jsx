...
const CheckoutPage = () => {
  ...
  const paystackConfig = {
    ...
    metadata: {
      custom_fields: [
        { display_name: "Student Name", variable_name: "student_name", value: user?.name },
        { display_name: "Courses", variable_name: "courses", value: cartItems.map((c) => c.title).join(", ") },
      ],
    },
  };
        ...
        <div className="container-custom max-w-4xl">
          <div className="grid md:grid-cols-5 gap-8">
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              {cartItems.map((item) => (
                <div key={item._id} className="flex items-center gap-4 bg-white border rounded-lg p-4">
                  <img
                    src={item.thumbnail || "https://placehold.co/100x70/4f46e5/white?text=Course"}
                    alt={item.title}
            ...
            <div className="md:col-span-2">
              <div className="bg-white border rounded-xl p-6 sticky top-24">
                ...
                <p className="text-xs text-gray-500 mt-4 leading-relaxed">
                  By completing this purchase you agree to our terms. An admission
                  letter will be sent to your email upon successful payment.
                </p>
              </div>
            </div>
          </div>
